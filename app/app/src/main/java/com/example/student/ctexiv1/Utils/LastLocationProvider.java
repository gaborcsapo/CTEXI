...
public class LastLocationProvider extends AppCompatActivity {
            ...
            public void onLocationChanged(Location location) {
                ...
                runOnUiThread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        Toast.makeText(LastLocationProvider.this, "Best Provider update", Toast.LENGTH_SHORT).show();
                    }
                });
            }
            ...
            public void onLocationChanged(Location location) {
                ...
                runOnUiThread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        Toast.makeText(LastLocationProvider.this, "Network Provider update", Toast.LENGTH_SHORT).show();
                    }
                });
            }
            ...
            public void onLocationChanged(Location location) {
                ...
                runOnUiThread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        Toast.makeText(LastLocationProvider.this, "GPS Provider update", Toast.LENGTH_SHORT).show();
                    }
                });
            }
